      ...
      <div className="h-screen w-full dark:bg-black-100 bg-white dark:bg-grid-white/[0.03] bg-grid-black/[0.2] absolute top-0 left-0 flex items-center justify-center">
        ...
        <div className="flex justify-center relative my-20 z-10">
          <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
            <TextGenerateEffect 
            className="text-center text-[40px] md:text-5xl lag:text-6xl"
            words="Welcome to my Portfolio! :)"
            /> <br />

            <h4 className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
              Hi, I&apos;m <span className="text-purple">DEVIKA HARSHEY</span><br/> 
              <span className="text-xs md:text-base lg:text-xl">Writer | CSE Student | Front-End Developer</span>
            </h4><br />
